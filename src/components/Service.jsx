    ...
    <div className="shadow-sm p-4 my-4">
      ...
      <form action="">
        <div className=" d-flex-row justify-content-between text-center">
          <button type="button" class="btn btn-outline-danger mx-2 my-3">
            {" "}
            appointment to get vaccinated against covid 19
          </button>
          <button type="button" class="btn btn-outline-warning mx-2 my-3">
            appointment to change glasses
          </button>
          <button type="button" class="btn btn-outline-info mx-2 my-3">
            {" "}
            appointment to see the doctor
          </button>
          <button type="button" class="btn btn-outline-danger mx-2 my-3">
            appointment to change driver licence
          </button>
          <button type="button" class="btn btn-outline-warning mx-2 my-3">
            {" "}
          ...
          <button type="button" class="btn btn-outline-info mx-2 my-3">
            appointment to change the national cards
          </button>
        </div>
        <div className="Row">
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control type="text" placeholder="service..." autoFocus />
            </Form.Group>
